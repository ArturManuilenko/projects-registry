...
class Jira(AtlassianRestAPI):
    ...
    def set_property(self, property_id, value):
        ...
        :return:
        """
        url = "rest/api/3/application-properties/{}".format(property_id)
    ...
    def get_application_role(self, role_key):
        ...
        :return:
        """
        url = "rest/api/3/applicationrole/{}".format(role_key)
        return self.get(url) or {}
    ...
    def get_attachment(self, attachment_id):
        ...
        :return:
        """
        url = "rest/api/3/attachment/{}".format(attachment_id)
        return self.get(url)
    ...
    def get_attachment_expand_human(self, attachment_id):
        ...
        :return:
        """
        url = "rest/api/3/attachment/{}/expand/human".format(attachment_id)
        return self.get(url)
    ...
    def get_attachment_expand_raw(self, attachment_id):
        ...
        :return:
        """
        url = "rest/api/3/attachment/{}/expand/raw".format(attachment_id)
        return self.get(url)
    ...
    def get_all_system_avatars(self, avatar_type="user"):
        ...
        """
        url = "rest/api/3/avatar/{type}/system".format(type=avatar_type)
        return self.get(url)
    ...
    def delete_cluster_node(self, node_id):
        ...
        :return:
        """
        url = "rest/api/3/cluster/node/{}".format(node_id)
        return self.delete(url)
    ...
    def set_node_to_offline(self, node_id):
        ...
        :return:
        """
        url = "rest/api/3/cluster/node/{}/offline".format(node_id)
        return self.put(url)
    ...
    def get_cluster_zdu_state(self):
        url = "rest/api/3/cluster/zdu/state"
        return self.get(url)
    ...
    def get_comment_properties_keys(self, comment_id):
        ...
        :return:
        """
        url = "rest/api/3/comment/{commentId}/properties".format(commentId=comment_id)
        return self.get(url)
    ...
    def update_component_lead(self, component_id, lead):
        ...
        return self.put(
            "rest/api/3/component/{component_id}".format(component_id=component_id),
            data=data,
        )
    ...
    def get_custom_field_option(self, option_id):
        ...
        :return:
        """
        url = "rest/api/3/customFieldOption/{id}".format(id=option_id)
        return self.get(url)
    ...
    def get_filter(self, filter_id):
        ...
        :return:
        """
        url = "rest/api/3/filter/{id}".format(id=filter_id)
        return self.get(url)
    ...
    def get_all_users(self, include_inactive_users=False, start=0, limit=10**8):
        """
        Just wrapping method get list of all users
    ...
    def issue(self, key, fields="*all", expand=None):
        ...
        return self.get("rest/api/3/issue/{0}?fields={1}".format(key, fields), params=params)
    ...
    def get_issue(self, issue_id_or_key, fields=None, properties=None, update_history=True):
        ...
        :return: issue
        """
        url = "rest/api/3/issue/{}".format(issue_id_or_key)
        params = {}
    ...
    def issue_createmeta(self, project, expand="projects.issuetypes.fields"):
        ...
        if expand:
            params["expand"] = expand
        url = "rest/api/3/issue/createmeta?projectKeys={}".format(project)
        return self.get(url, params=params)
    ...
    def get_issue_comments(self, issue_key):
        ...
        :return:
        """
        url = "rest/api/3/issue/{}comment".format(issue_key)
        return (self.get(url) or {}).get("comments")
    ...
    def issue_get_worklog(self, issue_id_or_key):
        ...
        :return:
        """
        url = "rest/api/3/issue/{issueIdOrKey}/worklog".format(issueIdOrKey=issue_id_or_key)
    ...
    def issue_archive(self, issue_id_or_key, notify_users=False):
        ...
        url = "rest/api/3/issue/{issueIdOrKey}/archive".format(issueIdOrKey=issue_id_or_key)
        return self.get(url)
    ...
    def issue_field_value(self, key, field, expand=None):
        ...
        if expand:
            params["expand"] = expand
        issue = self.get("rest/api/3/issue/{0}?fields={1}".format(key, field), params=params)
    ...
    def bulk_update_issue_field(self, key_list, fields="*all"):
        ...
        try:
            for key in key_list:
                self.put("rest/api/3/issue/{0}".format(key), data={"fields": fields})
        except Exception:
            return False
        return True
    ...
    def issue_add_watcher(self, issue_key, user):
        ...
        data = user
        return self.post(
            "rest/api/3/issue/{issue_key}/watchers".format(issue_key=issue_key),
            data=data,
        )
    ...
    def issue_edit_comment(self, issue_key, comment_id, comment, visibility=None):
        ...
        :return:
        """
        url = "rest/api/3/issue/{}/comment/{}".format(issue_key, comment_id)
        data = {"body": comment}
        if visibility:
            data["visibility"] = visibility
        return self.put(url, data=data)
    ...
    def user_remove(self, username=None, account_id=None, key=None):
        ...
        if key:
            params["key"] = key
        return self.delete("rest/api/3/user", params=params)
    ...
    def user_set_property(self, username, key_property, value_property):
        ...
        :return:
        """
        url = "rest/api/3/user/properties/{key_property}?username={user_name}".format(
    ...
    def add_user_to_application(self, username, application_key):
        ...
        return self.post("rest/api/3/user/application", params=params) is None
    ...
    def create_project_from_raw_json(self, json):
        ...
        :return:
        """
        return self.post("rest/api/3/project", json=json)
    ...
    def project(self, key, expand=None):
        ...
        if expand:
            params["expand"] = expand
        return self.get("rest/api/3/project/{0}".format(key), params=params)
    ...
    def get_project_versions_paginated(
        ...
        return self.get("rest/api/3/project/{}/version".format(key), params=params)
    ...
    def delete_version(self, version, moved_fixed=None, move_affected=None):
        ...
        return self.delete("rest/api/3/version/{}".format(version), data=payload)
    ...
    def get_project_actors_for_role_project(self, project_key, role_id):
        ...
        :return:
        """
        url = "rest/api/3/project/{projectIdOrKey}/role/{id}".format(projectIdOrKey=project_key, id=role_id)
    ...
    def delete_project_actors(self, project_key, role_id, actor, actor_type=None):
        ...
        :return:
        """
        url = "rest/api/3/project/{projectIdOrKey}/role/{roleId}".format(projectIdOrKey=project_key, roleId=role_id)
        params = {}
    ...
    def get_notification_scheme_for_project(self, project_id_or_key):
        ...
        :return:
        """
        url = "rest/api/3/project/{}/notificationscheme".format(project_id_or_key)
        return self.get(url)
    ...
    def get_notification_scheme(self, notification_scheme_id, expand=None):
        ...
        """
        url = "rest/api/3/notificationscheme/{}".format(notification_scheme_id)
        params = {}
        if expand:
            params["expand"] = expand
        return self.get(url, params=params)
    ...
    def get_priority_by_id(self, priority_id):
        ...
        :return:
        """
        url = "rest/api/3/priority/{}".format(priority_id)
        return self.get(url)
...
api-group-workflows/#api-rest-api-2-workflow-search-get)
    ...
    def get_all_priority_schemes(self, start=0, limit=100, expand=None):
        ...
        :return:
        """
        url = "rest/api/3/priorityschemes"
        params = {}
        if start:
            params["startAt"] = int(start)
        if limit:
    ...
    def create_priority_scheme(self, data):
        ...
        """
        return self.post(path="rest/api/3/priorityschemes", data=data)
    ...
    def get_priority_scheme_of_project(self, project_key_or_id, expand=None):
        ...
        if expand:
            params["expand"] = expand
        url = "rest/api/3/project/{}/priorityscheme".format(project_key_or_id)
        return self.get(url, params=params)
    ...
    def assign_priority_scheme_for_project(self, project_key_or_id, priority_scheme_id):
        ...
        :return:
        """
        url = "rest/api/3/project/{projectKeyOrId}/priorityscheme".format(projectKeyOrId=project_key_or_id)
    ...
    def get_security_level_for_project(self, project_key_or_id):
        ...
        """
        url = "rest/api/3/project/{projectKeyOrId}/securitylevel".format(projectKeyOrId=project_key_or_id)
        return self.get(url)
    ...
    def get_server_info(self, do_health_check=False):
        ...
        if do_health_check:
            ...
            check = False
        return self.get("rest/api/3/serverInfo", params={"doHealthCheck": check})

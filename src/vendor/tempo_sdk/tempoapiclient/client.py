...
# Worklogs
    ...
    def get_worklogs(self, dateFrom=None, dateTo=None, worklogId=None, jiraWorklogId=None, jiraFilterId=None, accountKey=None, projectKey=None, teamId=None, accountId=None, issueId=None):
        """
        ...
        if dateFrom:
            params.update({'from': self._resolve_date(dateFrom).isoformat()})
        
        if dateTo:
            params.update({'to': self._resolve_date(dateTo).isoformat()})
